...
const MyCourse = (props: Props) => {
  const { course } = props;
  return (
    <div className=" flex flex-col px-5 py-7 rounded-2xl bg-white gap-4 shadow-xl items-center overflow-hidden">
      <ImageOptimizing
      ...
      />
      <h3 className="text-2xl text-black font-normal h-[6rem] truncate w-[17rem] shrink-0 whitespace-normal">
        {course.course_name}
      </h3>
      <Link
