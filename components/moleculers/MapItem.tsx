...
const MapItem: React.FC<MapItemProps> = ({
  ...
  return (
    ...
    >
      {odd && (
        <>
          <div className="h-fit relative">
            <p className="absolute flex items-center justify-center w-[65%] -top-3 text-4xl font-bold bg-clip-text bg-[linear-gradient(90deg,_#3B8CD2_0%,_#50B2C6_100%)] z-30 right-0 text-transparent">
              <span className="text-center w-full"> {numStep}</span>
            </p>
            <svg
          ...
          <div className="w-[20vw] mt-12 ml-20">
            ...
            <div className="w-full h-[140px] overflow-y-auto grid grid-cols-2 my-4 pt-4 px-4 gap-3">
              {details?.map((detail) => (
                <TagSkill
      ...
      {!odd && (
        <>
          <div className="w-[20vw] mt-[40px] mr-20">
          ...
          <div className="h-fit relative">
            <p className="absolute flex items-center justify-center w-[65%] -top-3 text-4xl font-bold bg-clip-text bg-[linear-gradient(90deg,_#5F5796_0%,_#3B8AD0_100%,_#FFFFFF00_100%)] z-30 left-0 text-transparent">
              <span className="w-full text-center">{numStep}</span>
            </p>
            <svg
              className="h-[150px] -translate-y-8"
              viewBox="0 0 346 200"
